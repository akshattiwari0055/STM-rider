    ...
    <footer className="border-t border-white/10 bg-black pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-3xl font-bold mb-4 uppercase text-white tracking-widest"><span className="text-[#FFB300]">STM</span> Riders</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="https://maps.app.goo.gl/Jk9zUr5mBorsP6ULA" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Lawgate , Phagwara , Punjab</a>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@stmriders.com" className="text-gray-400 hover:text-white transition-colors">info@stmriders.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-500 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} STM Riders. All rights reserved.</p>
          <div className="flex gap-4">
