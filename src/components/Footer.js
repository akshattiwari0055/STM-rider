    ...
    <footer className="border-t border-white/10 bg-black pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-3xl font-bold mb-4 uppercase text-white tracking-widest"><span className="text-[#FFB300]">Singh</span> Bike Rentals</h3>
            <p className="text-gray-400 mb-6">Singh Bike Rentals - Premium car and bike rentals for elite travelers. Your journey, our wheels.</p>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-500 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} Singh Bike Rentals. All rights reserved.</p>
          <div className="flex gap-4">
